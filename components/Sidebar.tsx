      ...
      <div className="box-light p-md has-border-radius-md">
        <Grid columns={24} container rowSpacing={2} spacing={4}>
          ...
          <Grid item xs={24} sm={16} md={18} lg={24}>
            ...
            <p><strong><a href="https://twitter.com/rulleSOL" target="_blank">@rulleSOL</a></strong>. Masterful ETA recruit mentor, feet connoisseur and simian aficionado. The Ethereal Transit Authority and Nazuul himself commend your work ethic!</p>
          </Grid>
        </Grid>
      </div>
    </div>
